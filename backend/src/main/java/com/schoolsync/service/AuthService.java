...
public class AuthService {
    ...
    private final com.schoolsync.repository.ParentStudentRepository parentStudentRepository;
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        if (request.getRole().equals("Student")) {
            ...
            if (request.getChildRollNo() != null && !request.getChildRollNo().isBlank()) {
                ...
                com.schoolsync.entity.ParentStudent link = new com.schoolsync.entity.ParentStudent();
                link.setParent(user);
